...
export const getSocialImage = ({cloud_name, public_id, title, src, width, height }) => {
	...
	const titleTxt = encodeURIComponent(encodeURIComponent(title))

	return `https://res.cloudinary.com/${cloud_name}/image/upload/f_auto/c_fill,g_south_east,l_${public_id},r_20,w_500,x_50,y_50/c_fit,e_shadow:40,g_north_west,h_600,l_text:Source Sans Pro_120_bd:${titleTxt},w_900,x_100,y_150/v1623187283/bg/social-bg-1.png`

}

export const getVideoPosterUrl = ({cloud_name, public_id}) => {

	return `https://res.cloudinary.com/${cloud_name}/video/upload/f_auto/${public_id}.jpg`
}